...
<body>
    ...
    ?>
        <h1>Daftar Pengecatan</h1>
            ...
            <p><a href="index.php" class="button">tambah pengecatan</a></p>
            <footer>
            <h4>made with</h4>❤
            </footer>
    <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if(empty($panjang) or empty($lebar) or empty($tinggi)) {
                    ...
                    echo '<p><a href="index.php" class="button">kembali</a></p>';
                    echo '<footer>
                        <h4>made with</h4>❤
                        </footer>';
                    die();
                ...
                ?>
                    ...
                    <p>terima kasih !</p>
                    <p>
                        <a href="index.php" class="button">tambah lagi</a>
                        <!-- belum fix -->
                        <a href="index.php?lihat" class="button catatan">lihat catatan</a>
                    </p>
    <?php
                } else { 
    ?>
                ...
                <p>eror !</p>
                <p>
                    <a href="index.php" class="button">ulangi lagi</a>
                    <!-- belum fix -->
                    <a href="index.php?lihat" class="button catatan">lihat catatan</a>
                </p>
    <?php 
    ...
    <h1>Input Pengecatan</h1>
            <div class="container">
                ...
                <a href="index.php?lihat" class="lihat">lihat catatan</a>
            </div>
    <footer>
        <h4>made with</h4>❤
    </footer>
